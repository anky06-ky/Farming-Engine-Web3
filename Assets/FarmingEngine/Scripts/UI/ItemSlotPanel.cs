...
namespace FarmingEngine
{
    ...
    public class ItemSlotPanel : UISlotPanel
    {
        ...
        {
            // --- Web3: Block drag if wallet not valid ---
            if (!Web3WalletValidator.IsWalletValid())
            {
                Debug.LogWarning("[Web3] Cannot drag items: Wallet not set or NFT inventory not synced.");
        ...
        {
            // --- Web3: Block drag & drop if wallet not valid ---
            if (!Web3WalletValidator.IsWalletValid())
            {
                Debug.LogWarning("[Web3] Cannot drop items: Wallet not set or NFT inventory not synced.");
